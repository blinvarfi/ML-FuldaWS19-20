...
for i in range (0, 10):
    ax[i].imshow(eig_vec[:,i-5].reshape(28, 28))
plt.show()
...
eig_val, eig_vec = np.linalg.eigh(op_500)
transformed_500 = np.dot(first_500, eig_vec)
...
# 5.c)
print('Question 5.c)')
transformed_500_2 = np.dot(transformed_500, np.transpose(eig_vec))
